...
beautiful.init(awful.util.getdir("config") .. "/themes/chrysalis/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Mod1" }, "F10", function () awful.util.spawn("amixer set Master 2%+", false) end),
    awful.key({ "Mod1" }, "\\", function () awful.util.spawn("sh -c 'sleep 0.1; xdotool key --clearmodifiers Delete'", false) end),
    awful.key({ "Mod1" }, "Left", function () awful.util.spawn("sh -c 'sleep 0.1; xdotool key --clearmodifiers Home'", false) end),
    awful.key({ "Mod1" }, "Right", function () awful.util.spawn("sh -c 'sleep 0.1; xdotool key --clearmodifiers End'", false) end),
    awful.key({ "Mod1" }, "Up", function () awful.util.spawn("sh -c 'sleep 0.1; xdotool key --clearmodifiers Page_Up'", false) end),
    awful.key({ "Mod1" }, "Down", function () awful.util.spawn("sh -c 'sleep 0.1; xdotool key --clearmodifiers Page_Down'", false) end),
